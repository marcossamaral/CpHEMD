...
refene1.dielc2_energies(igb1=0, igb2=0, igb5=0, igb7=0, igb8=0)
refene1.dielc2.solvent_energies(igb1=0, igb2=0, igb5=0, igb7=0, igb8=0)
refene2 = _ReferenceEnergy(igb2=1.0, igb5=0, igb7=0, igb8=0) # Implicit 
refene2.solvent_energies(igb2=1.0, igb5=0, igb7=0, igb8=0) # Explicit 
refene2.dielc2_energies()
refene2.dielc2.solvent_energies()

CP4 = TitratableResidue('CP4',['C','C1','C2','N','C3',
'C4','Br','H','H1','H2',
'C5','N1','C6','C7','C8',
'H3','H4','C9','C10','H5',
'H6','C11','H7','H8','H9',
...
'C14','C15','C16','N2','N3',
'H17','H18','O1','H19','H20',
'H21','H22','H23'], pka=9.50, typ="ph")

CP4.add_state(protcnt=2, refene=refene1, refene_old=refene1, pka_corr=0.0, # deprotonated
charges=[-0.0770,-0.1362,0.4202,-0.6550,0.3668,
-0.1903,-0.0581,0.1580,0.1780,0.0401,
0.5696,-0.5419,0.0947,-0.0954,-0.0347,
0.0537,0.0537,-0.0764,-0.0774,0.0517,
0.0517,-0.0864,0.0867,0.0417,0.0417,
0.0462,0.0462,0.3275,-0.6131,0.1262,
0.0477,-0.0891,0.0447,0.0447,0.0447,
0.0934,0.0471,0.5522,-0.6499,-0.8848,
0.3938,0.3938,-0.4076,0.0612,0.0612,
0.0682,0.0682,0.0000])

CP4.add_state(protcnt=3, refene=refene1, refene_old=refene1, pka_corr=0.0, # protonated
charges=[-0.0740,-0.1292,0.4212,-0.6610,0.3558,
-0.1843,-0.0371,0.1650,0.1760,0.0441,
0.5736,-0.5529,0.1137,-0.1104,-0.0457,
0.0612,0.0612,-0.0794,-0.0764,0.0357,
0.0357,-0.0924,0.0767,0.0557,0.0557,
0.0587,0.0587,0.3345,-0.6151,0.1162,
0.0837,-0.0971,0.0697,0.0697,0.0697,
0.0844,0.0631,0.4112,-0.5019,-0.8036,
0.4698,0.4698,-0.3686,0.0932,0.0932,
0.0902,0.0902,0.4698])
